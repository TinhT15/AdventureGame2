...
/**
 * Write a description of class AdventureGame3 here.
 *
 * @author (your name)
...
public class AdventureGame3
{
    ...
    //Second choices of haunted house code   
    static void hhChoice2enter() {
    ...
    //Third choices of haunted house code  
    static void hhChoice3stairs() {
    ...
    //Fourth choices of haunted house code
    static void hhChoice4clear() {
    ...
    //First choice for far future
    static void ffChoice1() {
    ...
    //Second choices for far future
    static void ffChoice2enter() {
    ...
    static void ffChoice3mall() {
        ...
        System.out.println("You say, Um, my name is " + myName + ".");
        System.out.println("Well, your apparel is strange " + myName + ".");
        System.out.println("Um, I am just wearing some antique clothes. ");
    ...
    //Fourth choices for far future
    static void ffChoice4run() {
    ...
    static void ffChoice4talk() {
        ...
        System.out.println("You spend a few hours looking around, but now you are hungry. ");
        System.out.println("Do you want to find a fast food resauraunt(Enter 1), or go to a seafood restauraunt(Enter 2)? ");
    }
    
    //Fifth choices for far future  
    static void ffChoice5fastfood() {
        System.out.println("You head to a fastfood restaurant.");
        System.out.println("You eat some delicious fastfood, such as fries and burgers.");
    }
    
    static void ffChoice5seafood() {
        System.out.println("You head to a seafood restaurant.");
        System.out.println("You eat some delicious seafood, such as fish that were biologically modified to be larger, and juicier.");
    }
    
    static void headBackToPortal() {
        System.out.println("After you finished, you paid for your meal and then headed toward the portal. ");
    ...
    public static void main(String[] args){
        ...
        int chooseLocation = myObj.nextInt();     
        if (chooseLocation == 1)
        {
            System.out.println("You get in your car with your friend Bob,and he asks, Where are we going " + name);
            System.out.println("? We are going to a so called haunted house Bob. ");
            ...
            if (enterOrNot == 1)
            {
                ...
                System.out.println("If you want to go up the stairwell, then enter 1. ");
                System.out.println("If you want to go to the area with the living room, kitchen, and dining table, then enter 2. ");
                int stairsOrRooms = myObj.nextInt();
                switch (stairsOrRooms) 
                {
                    case 1:
                        hhChoice3stairs();
                        int bonesOrClear = myObj.nextInt();
                        switch (bonesOrClear)
                        {
                        case 1:
                            hhChoice4clear();
        ...
        else if (chooseLocation == 2)
        {
            System.out.println("You have found a portal to another time period,it says, The Future, on it. ");
            System.out.println("Do you want to enter it? Enter 1 to enter, enter 2 if you do not want to: ");
            int choosePortal = myObj.nextInt();
            if (choosePortal == 1)
            {
                System.out.println("You activate the portal, and jump in, not sure if you will be ready for what is on the other side.");
                System.out.println("As you appear on to the other side, you gasp in amazement at the sight of hover cars and robots everywhere!");
